...
public class AdminController {
	...
	public ResponseEntity<?> deleteStudent(Model model, @PathVariable(value = "ID") int id, @RequestParam("c_enrolled") String enroll_course, @RequestParam("enrolled") List<String> enroll_users) {
